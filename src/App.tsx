...
export const App = () => {
  return (
    <Container className="bg-[#f7e8db]">
      <Box className="bg-[#ec755d] w-lg h-24 rounded-2xl p-5 max-w-xs sm:max-w-md md:max-w-lg">
      ...
      <Box className="bg-white w-lg h-full rounded-2xl p-4 sm:p-8 mt-5 max-w-xs sm:max-w-md md:max-w-lg">
        <Box className="w-full h-full justify-start items-start flex-col">
