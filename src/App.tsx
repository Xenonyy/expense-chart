...
export const App = () => {
  return (
    <Container className="bg-[#f7e8db]">
      <Box className="bg-[#ec755d] h-24 rounded-2xl p-5 min-w-xs md:w-lg min-lg:min-w-xl">
      ...
      <Box className="bg-white h-full rounded-2xl p-4 sm:p-8 mt-5 min-w-xs md:w-lg min-lg:min-w-xl ">
        <Box className="w-full h-full justify-start items-start flex-col">
